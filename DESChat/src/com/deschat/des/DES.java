...
public class DES {
	...
	public static void main(String[] args) {
		...
		System.out.println(DES.toBinary(0xa,4));
		System.out.println(DES.toBinary('a',8));
		String a="abcdef";
		String s="\0\0";
        ...
        String str2 = "str2";
        String str3 = "str3";
        String str4 = "str4\0str4\0";
        String str5 = "str5"+""+"str5";
        ...
        str4=str4.replaceAll("\0+$", "");
        System.out.println(str4);
        String s1="A";
		String key="DESENCRY";
		DES en=new DES(key);
		String s2=en.getResult(s1,true);
		String s3=en.getResult(s2,false);
		System.out.println(s3);
		System.out.println(s3.length());
		String temp=en.getResult("哈哈",true);
		System.out.println(en.getResult(temp, false));
		System.out.println(Base64Tool.base64Encode("eknjcnkejcnkwejc"));
		temp=en.getResult(Base64Tool.base64Encode("eknjcnkejcnkwejc"),true);
		System.out.println(en.getResult(temp, false));
		/*temp=en.getResult("哈哈",true);
		System.out.println(en.getResult(temp, false));*/
		/*try {
		...
		for(int i=0;i<b.length;i++) {
			//System.out.println(b[i]==temp.charAt(i));
			//System.out.println(i+": "+(byte)c[i]+" "+b[i]);
			ss.append((char)b[i]);
		}
		/*String temp1=ss.toString();
		System.out.println(temp1.equals(temp));
		System.out.println(en.getResult(temp1, false));
		System.out.println(en.getResult(temp, false));*/
		/*String base64encodedString;
		try {
			base64encodedString = Base64.getEncoder().encodeToString("可非黑即白超级伙伴".getBytes("utf-8"));
			System.out.println("Base64 编码字符串 (基本) :" + base64encodedString);
	        // 解码
	        byte[] base64decodedBytes = Base64.getDecoder().decode(en.getResult(en.getResult(base64encodedString, true),false));
